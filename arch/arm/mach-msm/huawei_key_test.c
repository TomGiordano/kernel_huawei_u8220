...
struct usr_key usr_key_map[] ={
    {"back",  158},       /* KEY_BACK 158 */
	{"home",  102},       /* KEY_HOME 102 */
	{"menu",  229},       /* KEY_MENU  229  */
	{"power", 116},       /* KEY_POWER  116 */
	...
	{"send",  61},        /* CALL 61 */ 
	{"end",   62},        /* ENDCALL 62 */
	{"vup",   115},       /* KEY_VOLUMEUP 115 */ 
	{"vdown", 114},       /* KEY_VOLUMEDOWN 114 */
	{"camera",212},       /* KEY_CAMERA 212 */
	{"ok",    232},       /* DPAD_CENTER 232 */
    {"focus", 249},       /* KEY_FOCUS  249  */  
};
