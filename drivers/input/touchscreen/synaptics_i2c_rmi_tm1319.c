...
succeed_find_device:
	...
	if (ts->power) {
        ...
        //printk("*********  synaptics_ts_power positive values +D Set Sensitivity Adjust  *************** \n");
	}
